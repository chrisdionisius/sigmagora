                    ...
                    <form class="form-default" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input id="name" type="text" name="name" class="form-control @error('name') is-invalid @enderror" 
                                placeholder="azyrusmax" value="{{ old('name') }}" required autocomplete="name" autofocus>
                                @error('name')
                        ...
                        <div class="form-group">
                            ...
                            <input id="email" type="email" name="email" class="form-control @error('email') is-invalid @enderror" 
                                placeholder="Sample@sample.com" value="{{ old('email') }}" required autocomplete="email">
                                @error('email')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group">
                            <button type="submit" class="btn btn-secondary btn-block">{{ __('Register') }}</a>
                        </div>
